...
println(typeof(toggles[1].active)) # >Observable
println(typeof(toggles[1].alignmode)) # >Observable
println(typeof(toggles[1])) # > Toggle
# Toggle's attributes are observables (?)
