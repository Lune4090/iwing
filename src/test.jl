...
mutable struct MyCollisionMesh <: MyAbstractCollisionMesh
    Vertices::Vector{Point3f}
    Faces::Vector{TriangleFace}
    PostureDirectionVector::Point3f
    dim::Int
    polygons::Int
...
p31 = Point(3.0, 1.0, 9.0)
p32 = Point(1.0, 4.0, 3.0)
p33 = Point(2.0, 5.0, 2.0)

poly3 = Polygon([p31, p32, p33])

@show poly3

# mesh()の第一引数の型のMeshableは
#=
...
faceface = TriangleFace([1, 2, 3]) # TriangleFace<:AbstractNgonFace<:AbstractFace<:StaticVectorだった
faceface2 = TriangleFace([2, 1, 3])
